<script lang="ts">
	...
	import { ADMIN_EMAIL, APP_NAME, PROD_DOMAIN } from '$lib/glue/config';
</script>
		...
		<div data-custom-class="body">
			<div align="center" style="text-align: left;">
				...
				<div class="MsoNormal" data-custom-class="subtitle" style="line-height: 1.5;">
					...
					<bdt class="question"><strong>May 04, 2023</strong></bdt>
				</div>
...
mso-themetint:166;"
					...
					at
					<bdt class="question">151 dryden road</bdt>
					<bdt class="block-component" />
					,
					<bdt class="question">Ithaca</bdt>
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						the website
						<bdt class="question">
							<a href={PROD_DOMAIN} target="_blank" data-custom-class="link">
								{PROD_DOMAIN}
							</a>
						</bdt>
						(the
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						phone at
						<bdt class="question">607-379-1945</bdt>
						, email at
						<bdt class="question">{ADMIN_EMAIL}</bdt>
						<bdt class="block-component" />
						,
						<bdt class="statement-end-if-in-editor" />
						or by mail to
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						<bdt class="question">{APP_NAME}</bdt>
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						right, in our sole discretion, to make changes or modifications to these Legal Terms <bdt
						...
						have accepted, the changes in any revised Legal Terms by your continued use of the Services
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
						...
						<bdt data-type="conditional-block"><bdt class="block-component" /></bdt>
					</bdt>
				</div>
				<div class="MsoNormal" style="line-height: 1;"><br /></div>
				<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
				...
				<div class="MsoNormal" style="line-height: 1.5;">
					<a data-custom-class="link" href="#license">
						<span style="font-size: 15px;">
							<span data-custom-class="body_text">
								9. CONTRIBUTION <bdt class="block-component" />
								LICENSE
								<bdt class="statement-end-if-in-editor" />
							</span>
						</span>
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
				...
				<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
					<span style="font-size: 15px;">
						This <bdt class="block-component" />
						license
						<bdt class="statement-end-if-in-editor" />
				...
				<div class="MsoNormal" style="text-align: justify; line-height: 1;">
					...
					>
						<span style="font-size: 11pt; line-height: 16.8667px; ">
							...
							commercial <bdt class="block-component" />
							endeavors
							<bdt class="statement-end-if-in-editor" />
									...
									<bdt data-type="body">
										<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
											<span style="font-size: 11pt; line-height: 16.8667px; ">
												...
												<bdt class="else-block"><bdt class="block-component" /></bdt>
											</span>
										</div>
									</bdt>
								</bdt>
							...
							<bdt data-type="body">
								<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
									<span style="font-size: 11pt; line-height: 16.8667px; ">
										...
										re-categorize
										<bdt class="statement-end-if-in-editor" />
										any Contributions to place them in more appropriate locations on the Services; and
										(3) to pre-screen or delete any Contributions at any time and for any reason, without
			...
			<div align="center" style="text-align: left;">
					...
					<span style="font-size: 11pt; line-height: 16.8667px; ">
						...
						<strong>
							...
							<bdt
								...
								data-type="question"
							>
								<a href="{PROD_DOMAIN}/privacy-policy" target="_blank" data-custom-class="link">
									{PROD_DOMAIN}/privacy-policy
								</a>
							</bdt>
						</strong>
				...
				>
					<span style="font-size: 11pt; line-height: 16.8667px; ">
						...
						accordance with the laws of <bdt
							class="block-container if"
							data-type="if"
				...
				>
					<span style="font-size: 15px;">
						...
						related to these Legal Terms (each a <bdt class="block-component" />
				...
				>
					...
					<span style="font-size: 15px;">
						...
						<bdt class="block-component" />
						<bdt class="question">Tompkins</bdt>
						,
						<bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" />
						<bdt class="question">New York</bdt>
				...
				>
					...
					<bdt class="statement-end-if-in-editor" style="font-size: 15px;" />
					<bdt class="block-component" style="font-size: 15px;" />
					<bdt class="question" style="font-size: 15px;">New York</bdt>
					<bdt class="statement-end-if-in-editor" style="font-size: 15px;" />
					<span style="font-size: 15px;">
				...
				>
					...
					on a class-action basis or to <bdt class="block-component" />
					utilize
					<bdt class="statement-end-if-in-editor" />
				...
				<div class="MsoNormal" style="line-height: 1.5; text-align: left;">
					<bdt class="statement-end-if-in-editor"><bdt class="statement-end-if-in-editor" /></bdt>
				</div>
				<div class="MsoNormal" style="line-height: 1.5; text-align: left;"><br /></div>
				<div
					class="MsoNormal"
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						JUDGMENT
						<bdt class="statement-end-if-in-editor" />
						AND EXERCISE CAUTION WHERE APPROPRIATE. {APP_NAME} does not conduct criminal background or
						identity verification checks on its users. Though {APP_NAME} strives to encourage a respectful
						user experience, it is not responsible for the conduct of any user on or off the Service.
						Use your best judgment when interacting with others. YOU UNDERSTAND THAT {APP_NAME} DOES
						NOT CONDUCT CRIMINAL BACKGROUND OR IDENTITY VERIFICATION CHECKS ON ITS USERS OR OTHERWISE
						INQUIRE INTO THE BACKGROUND OF ITS USERS. {APP_NAME} MAKES NO REPRESENTATIONS OR WARRANTIES
						AS TO THE CONDUCT, IDENTITY, HEALTH, PHYSICAL CONDITION, INTENTIONS, LEGITIMACY, OR VERACITY
						OF USERS. {APP_NAME} RESERVES THE RIGHT TO CONDUCT - AND YOU AUTHORIZE {APP_NAME}
						TO CONDUCT - ANY CRIMINAL BACKGROUND CHECK OR OTHER SCREENINGS (SUCH AS SEX OFFENDER REGISTER
						SEARCHES) AT ANY TIME USING AVAILABLE PUBLIC RECORDS, AND YOU AGREE THAT ANY INFORMATION
						YOU PROVIDE MAY BE USED FOR THAT PURPOSE. IF THE COMPANY DECIDES TO CONDUCT ANY SCREENING
						THROUGH A CONSUMER REPORTING AGENCY, YOU HEREBY AUTHORIZE THE COMPANY TO OBTAIN AND USE A
						CONSUMER REPORT ABOUT YOU TO DETERMINE YOUR ELIGIBILITY UNDER THESE TERMS. YOU ARE SOLELY
						RESPONSIBLE FOR YOUR INTERACTIONS WITH OTHER USERS. WE CANNOT AND DO NOT GUARANTEE YOUR SAFETY
						AND ARE NOT A SUBSTITUTE FOR FOLLOWING SENSIBLE SAFETY PRECAUTIONS. ALWAYS USE YOUR BEST
						JUDGMENT AND TAKE APPROPRIATE SAFETY PRECAUTIONS WHEN COMMUNICATING WITH OR MEETING NEW PEOPLE.
						COMMUNICATIONS RECEIVED THROUGH THE SERVICE, INCLUDING AUTOMATIC NOTIFICATIONS SENT BY {APP_NAME},
						MAY RESULT FROM USERS ENGAGING WITH THE SERVICE FOR IMPROPER PURPOSES, INCLUDING FRAUD,
						ABUSE, HARASSMENT, OR OTHER SUCH IMPROPER BEHAVIOR. Though {APP_NAME} strives to encourage
						a respectful user experience, it is not responsible for the conduct of any user on or off
						the Service. You agree to use caution in all interactions with other users, particularly
						if you decide to communicate off the Service or meet in person.
					</span>
				</div>
				<div class="MsoNormal" style="line-height: 1.5; text-align: left;"><br /></div>
				<div
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						<span data-custom-class="body_text">
							{APP_NAME}'s liability is limited to the maximum extent allowed by applicable law. {APP_NAME}
							is not responsible for the conduct of any user on or off the Service. Use your best judgment
							when interacting with others. IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
					>
						...
						drafted them. You hereby waive any and all <bdt class="block-component" />
						defenses
						<bdt class="statement-end-if-in-editor" />
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
				...
				>
					<span style="font-size: 15px;">
						<span style="">
							<bdt class="question"><strong>{APP_NAME}</strong></bdt>
				...
				>
					<span style="font-size: 15px;">
						<span style="line-height: 115%; font-family: Arial; ">
							<bdt class="question">
								<strong><bdt class="question">151 dryden road</bdt></strong>
							</bdt>
							<span style="line-height: 115%; font-family: Arial; ">
								<bdt class="statement-end-if-in-editor" />
							</span>
				...
				>
					<span style="font-size: 15px;">
						...
						<strong>
							<span style=""><bdt class="block-component" /></span>
							<bdt class="block-component" />
							<bdt class="block-component" />
						</strong>
					</span>
...
Calibri;mso-themecolor:text1;mso-themetint:166;"
						>
							<strong><bdt class="question">{ADMIN_EMAIL}</bdt></strong>
						</span>
					</strong>
				</div>
			</div>
